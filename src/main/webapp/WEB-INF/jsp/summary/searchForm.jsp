...
<form id="searchForm" class="form-inline search-form" data-change-search="true">
    ...
    <esform:input path="search.po.order_number_like" cssClass="input-medium" placeholder="模糊匹配"/>
    &nbsp;&nbsp;
    <esform:label path="search.po.serial_number_like">序列号</esform:label>
    <esform:input path="search.po.serial_number_like" cssClass="input-medium" placeholder="模糊匹配"/>
    &nbsp;&nbsp;
