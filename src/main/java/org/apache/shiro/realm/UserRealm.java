...
import ee.common.repository.support.SimpleBaseRepositoryFactoryBean;
import ee.sys.auth.service.UserAuthService;
import ee.sys.user.entity.User;
import ee.sys.user.exception.UserBlockedException;
import ee.sys.user.exception.UserException;
