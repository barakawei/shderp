...
public class UploadController extends BaseCRUDController<UploadFile, Long> {
    ...
    @Override
    public String create(Model model, @Valid @ModelAttribute("m") UploadFile upload, BindingResult result, RedirectAttributes redirectAttributes) {
    ...
    public String create(
            ...
            @Valid @ModelAttribute("m") UploadFile upload, BindingResult result,
    ...
    @Override
    public String update(Model model, @Valid @ModelAttribute("m") UploadFile upload, BindingResult result, @RequestParam(value = "BackURL", required = false) String backURL, RedirectAttributes redirectAttributes) {
        throw new RuntimeException("discarded method");
    }
