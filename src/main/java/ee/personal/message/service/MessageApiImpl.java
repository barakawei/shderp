 ...
 */
package ee.personal.message.service;
...
import ee.personal.message.entity.Message;
import ee.personal.message.entity.MessageContent;
import ee.personal.message.entity.MessageState;
import ee.personal.message.entity.MessageType;
