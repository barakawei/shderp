 ...
 */
package ee.common.web.bind.method;
 ...
 *         search.age_lt=12
 *         排序及分页请参考 {@link PageAttributeArgumentResolver}
 *     1.2、控制器处理方法写法
 ...
 * @since 3.1
 */
public class SearchAttributeMethodArgumentResolver extends BaseMethodArgumentResolver {

    private static final PageAttributeArgumentResolver DEFAULT_PAGEABLE_RESOLVER = new PageAttributeArgumentResolver();
     ...
     * 分页参数解析器
     */
    private PageAttributeArgumentResolver pageableMethodArgumentResolver = DEFAULT_PAGEABLE_RESOLVER;

    public void setPageableMethodArgumentResolver(PageAttributeArgumentResolver pageableMethodArgumentResolver) {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer, NativeWebRequest webRequest, WebDataBinderFactory binderFactory) throws Exception {
        ...
        SearchAttribute searchDefaults = getSearchableDefaults(parameter);
    ...
    private SearchAttribute getSearchableDefaults(MethodParameter parameter) {
        //首先从参数上找
    	SearchAttribute searchDefaults = parameter.getParameterAnnotation(SearchAttribute.class);
        //找不到从方法上找
        if (searchDefaults == null) {
            searchDefaults = parameter.getMethodAnnotation(SearchAttribute.class);
        }
        return searchDefaults;
    }


    private Searchable getDefaultFromAnnotation(SearchAttribute searchableDefaults) {
    ...
    private Searchable defaultSearchable(SearchAttribute searchableDefaults) {
