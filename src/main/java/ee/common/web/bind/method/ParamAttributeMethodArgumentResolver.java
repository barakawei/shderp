...
public class ParamAttributeMethodArgumentResolver extends BaseMethodArgumentResolver {
    ...
    public ParamAttributeMethodArgumentResolver() {
    }

    @Override
    public boolean supportsParameter(MethodParameter parameter) {
        if (parameter.hasParameterAnnotation(ParamAttribute.class)) {
            return true;
        }
        return false;
    }
    ...
    public final Object resolveArgument(MethodParameter parameter,
        ...
        String name = parameter.getParameterAnnotation(ParamAttribute.class).value();
    ...
    private ServletRequest prepareServletRequest(Object target, NativeWebRequest request, MethodParameter parameter) {
        ...
        String modelPrefixName = parameter.getParameterAnnotation(ParamAttribute.class).value();
