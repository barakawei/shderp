...
import ee.common.search.exception.InvalidSearchPropertyException;
import ee.common.search.exception.InvalidSearchValueException;
import ee.common.search.exception.SearchException;
import ee.common.search.filter.AndCondition;
import ee.common.search.filter.Condition;
import ee.common.search.filter.OrCondition;
import ee.common.search.filter.SearchFilter;
import ee.common.utils.SpringUtils;
 ...
 * <p>Version: 1.0
 */
public final class SearchableConverter {
     ...
     * value="ee.common.entity.search.utils.SearchableConvertUtils.setConversionService"/>
    ...
    public static void setConversionService(ConversionService conversionService) {
        SearchableConverter.conversionService = conversionService;
    }

    public static ConversionService getConversionService() {
        if (conversionService == null) {
            synchronized (SearchableConverter.class) {
                if (conversionService == null) {
                    try {
                        ...
                        throw new SearchException("conversionService is null, " +
                                ...
                                "please see [ee.common.entity.search.utils." +
